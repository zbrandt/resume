...
\usepackage[
    pdftitle={Zachary Brandt's CV},
    pdfauthor={Zachary Brandt},
...
\begin{document}
    ...
    \begin{header}
        \textbf{\fontsize{24 pt}{24 pt}\selectfont Zachary Brandt}
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{mailto:zbrandt@berkeley.edu}{\color{black}{\footnotesize\faEnvelope[regular]}\hspace*{0.13cm}zbrandt@berkeley.edu}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:+1-650-283-32-36}{\color{black}{\footnotesize\faPhone*}\hspace*{0.13cm}(650) 283-3226}}%
        \kern 0.25 cm%
        \AND%
        % \kern 0.25 cm%
        ...
        % \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://linkedin.com/in/zacharypbrandt}{\color{black}{\footnotesize\faLinkedinIn}\hspace*{0.13cm}zacharypbrandt}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://github.com/zbrandt}{\color{black}{\footnotesize\faGithub}\hspace*{0.13cm}zbrandt}}%
    \end{header}
    ...
    \section{Education}
        ...
        \textit{August 2023 – Present}}
            ...
            \textit{BA in Economics, Data Science}
        \end{twocolentry}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item \textbf{Coursework:} Data Structures, Econometrics, Linear Algebra and Differential Equations
            \end{highlights}
        \end{onecolentry}
